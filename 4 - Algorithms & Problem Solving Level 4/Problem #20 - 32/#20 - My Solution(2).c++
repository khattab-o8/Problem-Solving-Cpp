...
stDate IncreaseDateByOneWeek(short Days, stDate Date)
{
	for (short i = 1; i <= Days; i++)
	{
		Date = IncreaseDateByOneDay(Date);
...
stDate IncreaseDateByX_Weeks(short weeks, stDate Date)
{
	...
	{
		Date = IncreaseDateByOneWeek(7, Date);
	}
...
stDate IncreaseDateByX_YearsFaster(stDate Date)
{
	Date.Year += 10;
	return Date;
}

stDate IncreaseDateByOneDecade(short Years, stDate Date)
{
	for (short i = 1; i <= Years; i++)
	{
		Date = IncreaseDateByOneYear(Date);
...
stDate IncreaseDateByX_Decades(short Decades, stDate Date)
{
	...
	{
		Date = IncreaseDateByOneDecade(10, Date);
	}
	return Date;
}

stDate IncreaseDateByX_DecadesFaster(stDate Date)
{
	Date = IncreaseDateByX_Decades(10, Date);
	return Date;
}

stDate IncreaseDateByoneCentury(short Decades, stDate Date)
{
	for (short i = 1; i <= Decades; i++)
	{
		Date = IncreaseDateByOneDecade(10, Date);
...
stDate IncreaseDateByOneMillennium(short Centuries, stDate Date)
{
	for (short i = 1; i <= Centuries; i++)
	{
		Date = IncreaseDateByoneCentury(10, Date);
	}
	return Date;
}
...
void PrintDateAfterUpdate()
{
	...
	Date = IncreaseDateByX_YearsFaster(Date);
	...
	Date = IncreaseDateByX_DecadesFaster(Date);
