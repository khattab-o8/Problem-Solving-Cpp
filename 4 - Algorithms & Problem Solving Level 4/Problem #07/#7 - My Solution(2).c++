...
int main()
{
	...
	cout << "Day Order  : " << CalculateGregorianCalender_d(Calculate_m(Calculate_a(Month),Month), Calculate_y(Calculate_a(Month), Year), Day) << "\n";
	cout << "Day Name   : " << DaysOfWeek[(CalculateGregorianCalender_d(Calculate_m(Calculate_a(Month), Month), Calculate_y(Calculate_a(Month), Year), Day))] << "\n";
